...
private:
  ...
  int16_t num_rows_{0};
  //第0列的索引表
  std::unordered_map<int16_t, std::vector<int32_t>> index_0;
  //第1列的索引表
  std::unordered_map<int16_t, std::vector<int32_t>> index_1;
  //第2列的索引表
  std::unordered_map<int16_t, std::vector<int32_t>> index_2;
  char *rows_{nullptr};
};
} // namespace bytedance_db_project
